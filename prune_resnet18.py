...
from data import *
from quantization import Quantized
import trainer2
from utils import *
import numpy as np
import copy
from pruning import Pruned

BASE_MODEL_PATH = "models/group8_resnet20_for_cifar10_mixup.pth"
USE_CIFAR10 = True
USE_CIFAR100 = False
...
if USE_CIFAR10:
    ...
    train_dataset = get_cifar100_train(transform_train)
    test_dataset = get_cifar100_test(transform_test)
    num_classes = 100
    dataset_description.append("cifar100")
else:
